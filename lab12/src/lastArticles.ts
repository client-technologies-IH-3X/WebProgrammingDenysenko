...
import type { Article, ArticlesState } from "./articleTypes.js";

const container = document.querySelector<HTMLDivElement>("#api-posts");
...
let state: ArticlesState = { status: "idle" };
...
function renderState() {
  ...
  switch (state.status) {
    ...
    case "success":
      ...
      state.data.forEach((article: Article) => {
